...
public class FragA11 extends Fragment {
    ...
    public void onActivityCreated( Bundle savedInstanceState) {
        ...
        getActivity().setTitle(choice);
        databaseReference= FirebaseDatabase.getInstance().getReference().child("BloodSeekerRelated").child("BloodSeekerPlace").child(choice);
        ...
        FirebaseRecyclerAdapter<Blog,FragA1.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, FragA1.BlogViewHolder>(
                Blog.class,
                R.layout.blog_row,
                FragA1.BlogViewHolder.class,
                databaseReference
            ...
            @Override
            protected void populateViewHolder(FragA1.BlogViewHolder viewHolder, Blog model,final int position) {
                Log.v("ROd","Rod"+post_key);
                ...
                viewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        ...
                        Intent i = new Intent(getActivity(), ViewRequest11.class);
