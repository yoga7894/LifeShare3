 ...
 */
public class FragE1 extends android.support.v4.app.Fragment {
    ...
    public void onActivityCreated( Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("UserRelated").child("UserBloodGroups").child(choice);
